...
namespace Nop.Plugin.OrderFullfillment.ShipwireINopStartup.Infrastructure
{
    class NopStartup : INopStartup
    {
        ...
        {
            // Establish the Http service for Shipwire.
            services.AddHttpClient<ShipwireServices>().WithProxy();
        }
