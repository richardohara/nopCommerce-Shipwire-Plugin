...
namespace Nop.Plugin.OrderFullfillment.Shipwire.Infrastructure
{
    class RouteProvider : IRouteProvider
    {
        ...
        public void RegisterRoutes(IRouteBuilder routeBuilder)
        {
            ...
            routeBuilder.MapRoute("Plugin.OrderFullfillment.Shipwire.Checkout.SelectShipping", "Checkout/SelectShippingMethod",
                new { controller = "OrderFullfillmentShipwireController", action = "ShippingMethod" });
        }
